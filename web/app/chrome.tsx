// The header and footer both pages share. The brand goes home, the nav goes to the one thing
// a reader can do next, and the GitHub mark is the octicon at 16 units.
export function Header({ create = true }: { create?: boolean }) {
  return (
    <header>
